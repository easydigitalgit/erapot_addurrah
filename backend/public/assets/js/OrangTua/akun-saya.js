document.addEventListener('DOMContentLoaded', () => {
    ...
    if (personalForm) {
        personalForm.addEventListener('submit', function(e) {
            ...
            fetch(`${BASE_URL}/orangtua/akun-saya/update`, {
                method: 'POST',
                body: formData,
    ...
    if (avatarInput) {
        avatarInput.addEventListener('change', function(e) {
            ...
            fetch(`${BASE_URL}/orangtua/akun-saya/upload-avatar`, { 
            ...
            .then(data => {
                ...
                if (data.status === 'success') {
                    ...
                    reader.onload = (e) => { 
                        // Update gambar profil besar di form
    ...
    if (passwordForm) {
        passwordForm.addEventListener('submit', function(e) {
            ...
            fetch(`${BASE_URL}/orangtua/akun-saya/update-password`, {
                method: 'POST', body: formData, headers: { 'X-Requested-With': 'XMLHttpRequest' }
            })
            .then(r => r.json())
            .then(data => {
...
window.savePreferences = function() {
    ...
    fetch(`${BASE_URL}/orangtua/akun-saya/update-preferences`, {
        method: 'POST', body: formData, headers: { 'X-Requested-With': 'XMLHttpRequest' }
    })
    .then(r => r.json())
    .then(data => {
