            ...
            <div class="relative z-10 text-center max-w-md">
                <div class="mb-6 lg:mb-8">
                    ...
                    <div class="w-20 h-20 lg:w-28 lg:h-28 mx-auto bg-white rounded-2xl shadow-lg flex items-center justify-center p-2 overflow-hidden">
                        <?php if ($logo_url): ?>
                            <img src="<?= $logo_url ?>" alt="Logo Sekolah" class="w-full rounded-lg object-contain">
                        <?php else: ?>
        ...
        <div class="w-full lg:w-1/2 p-6 lg:p-12 flex flex-col justify-center items-center bg-white">
            <div class="card-form w-full max-w-md">
                <div class="text-center mb-8">
                    <div class="lg:hidden flex pt-6 justify-center mb-6">
                        <div class="w-20 h-20 bg-white rounded-2xl shadow-lg flex items-center justify-center p-2 overflow-hidden border border-gray-100">
                            <?php if ($logo_url): ?>
                    ...
                    <h2 id="form-title" class="text-2xl lg:text-3xl pt-10 font-bold text-gray-800 mb-2 dark:b">Masuk ke Dashboard</h2>
                ...
                <form id="login-form" class="space-y-5">
                    ...
                    <div>
                        <label for="username" class="block text-sm font-medium text-gray-700 mb-2"> Email / Username / NIS </label>
                        <div class="relative">
                            ...
                            <input type="text" id="username" name="username" class="form-input w-full pl-12 pr-4 py-3.5 rounded-xl bg-gray-50 text-gray-800 placeholder-gray-400 outline-none focus:ring-2 focus:border-[<?= $color['warna_primary'] ?>] focus:ring-[<?= $color['warna_primary'] ?>]/50 transition-all" placeholder="Masukkan Email, Username, atau NIS" required>
                        </div>
                    </div>
    ...
    <div id="modalPilihRole" class="fixed inset-0 z-[100] flex items-center justify-center hidden">
        ...
        <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl relative z-10 overflow-hidden animate-scale-up m-4">
            <div class="bg-[<?= $color['warna_primary'] ?>] p-6 text-center">
                ...
                <p class="text-white text-sm mt-1">Email ini terhubung ke beberapa akun</p>
            </div>
