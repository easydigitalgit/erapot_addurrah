    ...
    <form id="personalInfoForm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="alamat" class="w-full px-4 py-2 border border-gray-200 dark:border-slate-600 bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-white rounded-lg focus:border-[var(--warna-primary)] outline-none" rows="3"><?= esc($user['alamat_domisili'] ?? '') ?></textarea>
            </div>
        </div>
