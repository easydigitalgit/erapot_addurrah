        ...
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
                ...
                <ul class="text-sm text-[<?= $color['warna_primary'] ?>] space-y-1">
                    <li class="flex items-center gap-2"><svg class="w-4 h-4 text-[<?= $color['warna_primary'] ?>]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> <?= lang('GuruMapel/Akun.banner_sec_1') ?></li>
                    <li class="flex items-center gap-2"><svg class="w-4 h-4 text-[<?= $color['warna_primary'] ?>]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> <?= lang('GuruMapel/Akun.banner_sec_2') ?></li>
                    <li class="flex items-center gap-2"><svg class="w-4 h-4 text-[<?= $color['warna_primary'] ?>]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> <?= lang('GuruMapel/Akun.banner_sec_3') ?></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <table class="activity-table w-full text-left ">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-slate-700">
                <?php if(empty($login_logs)): ?>
                    <tr><td colspan="4" class="text-center py-6 text-gray-500 dark:text-slate-400"><?= lang('GuruMapel/Akun.login_act_empty') ?></td></tr>
                <?php else: ?>
    ...
    <div class="card bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <div class="space-y-2">
                    <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-slate-400"><svg class="w-4 h-4 text-[<?= $color['warna_primary'] ?>]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> <?= lang('GuruMapel/Akun.role_acc_1') ?></div>
                    <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-slate-400"><svg class="w-4 h-4 text-[<?= $color['warna_primary'] ?>]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> <?= lang('GuruMapel/Akun.role_acc_2') ?></div>
                    <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-slate-400"><svg class="w-4 h-4 text-[<?= $color['warna_primary'] ?>]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> <?= lang('GuruMapel/Akun.role_acc_3') ?></div>
                    <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-slate-400"><svg class="w-4 h-4 text-[<?= $color['warna_primary'] ?>]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> <?= lang('GuruMapel/Akun.role_acc_4') ?></div>
                </div>
            </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl w-full max-w-md p-6 transform scale-95 transition-transform duration-300 shadow-2xl">
        ...
        <form id="changePasswordForm">
            <div class="space-y-4 mb-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-slate-300 mb-1"><?= lang('GuruMapel/Akun.modal_old_pass') ?></label> 
                    <input type="password" id="oldPassword" class="w-full px-4 py-2 border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[<?= $color['warna_primary'] ?>]" required>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-slate-300 mb-1"><?= lang('GuruMapel/Akun.modal_new_pass') ?></label> 
                    <input type="password" id="newPassword" class="w-full px-4 py-2 border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[<?= $color['warna_primary'] ?>]" required>
                    <p class="text-xs text-gray-500 mt-1"><?= lang('GuruMapel/Akun.modal_min_char') ?></p>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-slate-300 mb-1"><?= lang('GuruMapel/Akun.modal_confirm_pass') ?></label> 
                    <input type="password" id="confirmPassword" class="w-full px-4 py-2 border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[<?= $color['warna_primary'] ?>]" required>
                </div>
            </div>
