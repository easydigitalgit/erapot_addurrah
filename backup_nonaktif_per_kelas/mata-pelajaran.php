        ...
        <form id="addMapelForm" onsubmit="handleMapelSubmit(event)" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select name="status" required class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-700 border border-gray-300 dark:border-slate-600 text-gray-900 dark:text-white text-sm rounded-xl focus:bg-white dark:focus:bg-slate-800 focus:ring-2 focus:ring-[<?= $color['warna_primary'] ?>]/50 focus:border-[<?= $color['warna_primary'] ?>] block transition-all appearance-none cursor-pointer outline-none">
